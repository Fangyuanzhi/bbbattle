...
func (x *ReqPlayer) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *ReqPlayer) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ResPlayer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResPlayer) ProtoMessage() {}

func (x *ResPlayer) ProtoReflect() protoreflect.Message {
	mi := &file_logic_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResPlayer.ProtoReflect.Descriptor instead.
func (*ResPlayer) Descriptor() ([]byte, []int) {
	return file_logic_proto_rawDescGZIP(), []int{1}
}

func (x *ResPlayer) GetRoomId() string {
	if x != nil {
		return x.RoomId
	}
	return ""
...
func (x *ResPlayer) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *ResPlayer) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
var file_logic_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x6c, 0x6f, 0x67, 0x69, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x37, 0x0a,
	0x09, 0x52, 0x65, 0x71, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x55, 0x73,
	...
	0x52, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x4d, 0x0a, 0x09, 0x52, 0x65, 0x73, 0x50, 0x6c, 0x61,
	0x79, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x52, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x52, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x41,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x2e, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x63, 0x12, 0x25,
	0x0a, 0x0b, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x6f, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0a, 0x2e,
	0x52, 0x65, 0x71, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x1a, 0x0a, 0x2e, 0x52, 0x65, 0x73, 0x50,
	0x6c, 0x61, 0x79, 0x65, 0x72, 0x42, 0x07, 0x5a, 0x05, 0x2f, 0x6d, 0x61, 0x69, 0x6e, 0x62, 0x06,
...
var file_logic_proto_goTypes = []interface{}{
	(*ReqPlayer)(nil), // 0: ReqPlayer
	(*ResPlayer)(nil), // 1: ResPlayer
}
var file_logic_proto_depIdxs = []int32{
	0, // 0: Logic.GetRoomInfo:input_type -> ReqPlayer
	1, // 1: Logic.GetRoomInfo:output_type -> ResPlayer
